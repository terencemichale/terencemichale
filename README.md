...
- Turning a concrete task into a small, understandable application.
- Separating core logic from interfaces and external integrations.
- Making setup, sample data, error handling, and tests part of the project.
